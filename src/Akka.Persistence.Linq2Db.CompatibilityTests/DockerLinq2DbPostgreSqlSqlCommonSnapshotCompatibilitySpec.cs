...
namespace Akka.Persistence.Linq2Db.CompatibilityTests
{
    ...
    public class DockerLinq2DbPostgreSqlSnapshotCompatibilitySpec : SqlCommonSnapshotCompatibilitySpec
    {
...
#connection-string = ""FullUri=file:test.db&cache=shared""
        ...
        public DockerLinq2DbPostgreSqlSnapshotCompatibilitySpec(ITestOutputHelper output,
